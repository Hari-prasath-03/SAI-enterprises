        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="bg-gray-50 p-5">
            <Reveal className="text-gray-600 leading-relaxed">
              We can support at every stage. We work closely with clients,
              ensure clear communication, and deliver solutions that meet
              expectations with precision, trust, and consistent on-site and
              post-project assistance.
            </Reveal>
            <Reveal className="mt-4 font-semibold text-gray-800">
              SAI Enterprisess Team
            </Reveal>
          </div>

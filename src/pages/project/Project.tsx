    ...
    <div className="page">
      ...
      <div className="max-w-7xl mx-auto bg-white py-26 px-2">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex justify-between items-center border-t border-gray-200 pt-8">
              <button className="flex items-center gap-2 text-gray-700 hover:text-red-600 transition-colors">
                ...
                <Reveal className="font-semibold">Previous Project</Reveal>
              </button>
              <button className="flex items-center gap-2 text-gray-700 hover:text-red-600 transition-colors">
                <Reveal className="font-semibold">Next Project</Reveal>
                <svg
                  className="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8">
              ...
              <div className="bg-gray-50 p-6 mb-6">
                <Reveal className="text-lg font-bold text-gray-900 mb-4">
                  Project Info
                </Reveal>
        ...
        <div className="border-t border-gray-200 pt-16">
          <Reveal className="text-3xl font-bold text-gray-900 mb-8 text-center">
            Related Projects
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedProjects.map((project, index) => (
              <div
                key={index}
                className="relative group cursor-pointer overflow-hidden shadow-lg aspect-[4/5]"
              >
                <img
                  src={project.image}
                  alt={project.title}
                ...
                {project.isHighlight && (
                  <div className="absolute z-10 inset-0 flex flex-col items-center justify-center text-white bg-red/80">
                    ...
                    <img
                      src={plus}
                      alt="Plus"
                      className="border border-white p-3 size-9"
                    />
                  </div>
                )}
              </div>
